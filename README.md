[![Build Status](https://jenkins.platform.dev.nuxeo.com/buildStatus/icon?job=retention/nuxeo-retention/lts-2025)](https://jenkins.platform.dev.nuxeo.com/job/retention/job/nuxeo-retention/job/lts-2025/)
